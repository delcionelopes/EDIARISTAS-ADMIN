...
class ServicoRequest extends FormRequest
{
    ...
    /**
     * sobrescreve os valores antes da validação
     *
     * @return void
     */
    public function validationData()
    {
        ...
        $this->replace($dados); //substitui a request antiga por esta nova

        return $dados;
    }
/**
 * formata os valores monetários no padrão internacional aceitável pelo BD
 *
 * @param string $valor
 * @return void
 */
