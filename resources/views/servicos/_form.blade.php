                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="icone" id="icone" class="form-control">
                                    ...
                                    <option value="twf-cleaning-1" {{ isset($servico->icone) && $servico->icone === 'twf-cleaning-1' ? 'selected' : '' }}>ícone 1</option>
                                    <option value="twf-cleaning-2" {{ isset($servico->icone) && $servico->icone === 'twf-cleaning-2' ? 'selected' : '' }}>ícone 2</option>
                                    <option value="twf-cleaning-3" {{ isset($servico->icone) && $servico->icone === 'twf-cleaning-3' ? 'selected' : '' }}>ícone 3</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-4">
